...
// ----------------------------------------------------------------------------------------
const char* argv1 = "/Users/zhongsifen/Work/data/mnist";
int main_intro2(int argc, char** argv) {
	try
{
    if (argc != 2)
    {
...
//        return 1;
    ...
    load_mnist_dataset(argv1, training_images, training_labels, testing_images, testing_labels);
